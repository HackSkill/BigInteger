describe "Addition", ->
  ...
  it "adds two natural Integer with different number length.", ->
  ...
  it "adds two natural Integer with carry.", ->
  ...
  it "makes a substraction when the Integers' sign is different.", ->
    a = BigInteger.parse(-123456789)
